					...
					<form class="form-horizontal" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="username" class="form-control"
									id="username" placeholder="请输入用户名" value="${cookie.remembermeCookie.value}">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" value="1" name="autoLogin " ${not empty cookie.autoLoginCookie ? "checked='checked'" : ""} > 自动登录
									</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label> 
									<input type="checkbox" value="1" name="rememberme" ${not empty cookie.remembermeCookie? "checked='checked'" : "" }> 记住用户名
									</label>
								</div>
							</div>
						</div>
