	...
	<div class="container">
		<div class="row">
			...
			<c:if test="${empty cart.cartItems}">
				<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
					<strong style="font-size: 16px; margin: 5px 0;">您还有购物哦，快去购物哦</strong>
				</div>
			</c:if>
						...
						<tbody>
							...
							<c:forEach items="${cart.cartItems}" var="item">
								<tr class="active">
									...
									<td><a href="javascript:;" class="delete" id="${item.product.pid }">删除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
		...
		<div style="margin-right: 130px;">
			<div style="text-align: right;">
				<em style="color: #ff6600;"> <c:if test="${empty userLogin}">登录后确认是否享有优惠</c:if>&nbsp;&nbsp;
...
<script type="text/javascript">
	$(function(){
		$(".delete").click(function(){
			var pid = this.id;
			if(confirm("是否删除")){
				window.location.href="/store_v1.0/CartServlet?method=delteCartItem&pid="+pid;
			}
		});
	});
</script>
